...
for j = enLength:-100:0
    for i=1:noUAV
        ...
        if index>1 && index<21
            %updatedPosition = PSO(xUAV(i),yUAV(i),zUAV(i),minRate,150,40,320,xUser,yUser);
            updatedPosition = jDE(xUAV(i),yUAV(i),zUAV(i),minRate,150,40,320,xUser,yUser);
            up_xUAV(index,i) = updatedPosition(1);
            up_zUAV(index,i) = updatedPosition(2);
